function [graph_thresh] = how_to_choose_epsilon()
...
dist_options = [0,1,2,0.5]; % read worst_case_blob.m to understand the meaning of
%                               the parameter
...
max_tree(max_tree==0) = inf;
graph_thresh = min(min(max_tree.*similarities));
